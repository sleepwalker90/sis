...
class AttestationController extends Controller
{
    public function show(CourseLecturerAssignment $assignment)
    {
        ...
        return view('admin.attestations.show', compact('students', 'assignment'));
    }
    ...
    public function store(Request $request, CourseLecturerAssignment $assignment)
    {
        ...
        return redirect()->route('admin.attestations.show', $assignment)->with('success', 'Attestations updated successfully.');
    }
}
