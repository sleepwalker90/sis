        ...
        <div class="max-w-4xl mx-auto sm:p-6 lg:p-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    {{ __("Update $faculty->name faculty") }}
                </div>
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <form method="POST" action="{{ route('admin.faculties.update',['faculty' => $faculty->id ]) }}" class="max-w-2xl mx-auto my-8">
                        ...
                        <div class="py-2">
                            <label for="name" class="block text-sm font-medium text-gray-700">faculty Title</label>
                        ...
                        <div class="py-6">
                            <x-primary-button>Update faculty</x-primary-button>
                        </div>
