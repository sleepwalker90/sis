        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('admin.lecturers.store') }}">
                    ...
                    <div class="mb-4">
                        <label for="last_name" class="block text-sm font-medium text-gray-700">{{ __('Middle Name') }}</label>
                        <input type="text" id="last_name" name="last_name" class="block w-full mt-1 shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('middle_name') }}">
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="courses" class="block text-sm font-medium text-gray-700">{{ __('Courses') }}</label>
                    ...
                    <div class="flex justify-end">
                        <x-primary-button>{{ __('Create Lecturer') }}</x-primary-button>
                    </div>
                </form>
            </div>
        </div>
