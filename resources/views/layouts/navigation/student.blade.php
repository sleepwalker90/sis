        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('student.scholarship')" :active="request()->routeIs('student.scholarship')">
                        {{ __('Scholarship') }}
                    </x-nav-link>
                    <x-nav-link :href="route('student.dormitories.index')" :active="request()->routeIs('student.dormitories.index')">
                        {{ __('Общежития') }}
                    </x-nav-link>
